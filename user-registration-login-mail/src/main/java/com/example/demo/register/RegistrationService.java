...
import com.example.demo.register.email.EmailSender;
import com.example.demo.register.email.EmailValidator;
...
public class RegistrationService {
	...
	private static final String INVALID_EMAIL = "Invalid Email %s";
	private static final String INVALID_TOKEN = "Invalid token %s";
	...
	public String register(RegisterRequest request) {
		...
		if (!isValidEmail) {
			throw new IllegalStateException(String.format(INVALID_EMAIL, request.getEmail()));
		}
	...
	public String confirm(String token) {
		...
		ConfirmationToken confirmationToken = confirmationTokenService.getToken(token)
				.orElseThrow(() -> new IllegalStateException(String.format(INVALID_TOKEN, token)));
		...
		// token is valid need to activate account
